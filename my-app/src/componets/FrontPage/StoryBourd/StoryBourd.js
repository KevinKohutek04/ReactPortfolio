    ...
    return (
      <div className='StoryBourd' id="about">
        ...
        <p className="descriptionp">
            ...
            My journey began with the basics, then I took classes at <a href="https://techfios.com/" target="_blank" rel="noopener noreferrer" className="no-style-link">
            Tech Fios
          </a>, which taught me backend development.
            By 2021, my dedication paid off, and I landed an internship at <a href="https://www.homedepot.com" target="_blank" rel="noopener noreferrer" className="no-style-link">
            Home Depot
